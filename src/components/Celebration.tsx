...
export const Celebration: React.FC<CelebrationProps> = ({ onFinish, score }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50" style={{ transform: 'scale(2) translateY(-25%)', transformOrigin: 'center top' }}>
